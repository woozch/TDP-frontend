...
export function LeftSidebar({
  ...
  const upsertSessionSummary = useChatSessionStore(
    (state) => state.upsertSessionSummary,
  );
  ...
  return (
    <aside
      ref={sidebarRef}
      className="flex h-full w-full max-w-xs flex-col border-r border-gray-200 bg-gray-50/80 p-4 dark:border-gray-700 dark:bg-gray-900/80"
    >
                    ...
                    <div className="min-w-0 flex-1 space-y-2 text-left text-sm">
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        <span className="inline-flex items-center gap-1.5">
                          ...
                          <span aria-hidden>
                            {getLanguageOption(session.language).flag}
                          </span>
                        </span>
                      </p>
                    </div>
